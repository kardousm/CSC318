...
declare module 'framer' {
    ...
    export { Frame, FrameProperties, Scroll, Page, PageEffectDefault, Draggable, Stack, Navigation } from "framer/types/src/components";
    export { WithNavigator } from "framer/types/src/components/hoc/WithNavigator";
    export { NavigationTransitionOptions } from "framer/types/src/components/NavigationTransitions";
    ...
    export { Point, Size, Rect, Vector, VectorGroup, ComponentContainer, SVG, Text, componentLoader, setGlobalRenderEnvironment, RenderTarget, ControlType, PropertyControls, updateComponentLoader, getURLs, serverURL, NavigationLink, isReactDefinition, createDesignComponent, CanvasStore, isOverride, Color, ConvertColor, } from "framer/types/src/render";
    export { events };
...
declare module 'framer/types/src/components' {
    ...
    export { Page, PageEffectDefault } from "framer/types/src/components/Page";
...
declare module 'framer/types/src/components/hoc/WithNavigator' {
    ...
    import { NavigationTransitionOptions } from "framer/types/src/components/NavigationTransitions";
    ...
    export function WithNavigator<T, BaseProps extends React.ClassAttributes<T> & WithNavigator>(BaseComponent: React.ComponentType<BaseProps & {
        onTap?: any;
    }>, navigationTransition: string, navigationTransitionDirection: NavigationTransitionDirection, navigationComponent: (() => React.ReactNode) | undefined, navigationTransitionOverrides?: NavigationTransitionOptions): React.ComponentClass<BaseProps & WithNavigator>;
}
...
declare module 'framer/types/src/components/NavigationTransitions' {
    ...
    export namespace Transition {
        const Fade: NavigationTransitionOptions;
        const PushLeft: NavigationTransitionOptions;
        const PushRight: NavigationTransitionOptions;
        const PushDown: NavigationTransitionOptions;
        const PushUp: NavigationTransitionOptions;
        const Instant: NavigationTransitionOptions;
        const Modal: NavigationTransitionOptions;
        const OverlayTop: NavigationTransitionOptions;
        const OverlayBottom: NavigationTransitionOptions;
        const OverlayLeft: NavigationTransitionOptions;
        const OverlayRight: NavigationTransitionOptions;
        const FlipLeft: NavigationTransitionOptions;
        const FlipRight: NavigationTransitionOptions;
        const FlipDown: NavigationTransitionOptions;
        const FlipUp: NavigationTransitionOptions;
    }
}
...
declare module 'framer/types/src/render' {
    ...
    export { ControlDescription, CompactControlsDescription, BooleanControlDescription, NumberControlDescription, StringControlDescription, FusedNumberControlDescription, EnumControlDescription, SegmentedEnumControlDescription, ColorControlDescription, ImageControlDescription, FileControlDescription, ComponentInstanceDescription, ArrayControlDescription, ObjectControlDescription, ControlType, PropertyControls, } from "framer/types/src/render/types/PropertyControls";
...
declare module 'framer/types/src/components/Navigation' {
    ...
    export class Navigation extends React.Component<NavigationProps, NavigationState> implements Navigator {
        ...
        push: (Component: React.ReactNode, transition?: NavigationTransitionOptions, transitionOverrides?: NavigationTransitionOptions | undefined) => void;
        goBack: () => void;
        instant: (Component: React.ReactNode) => void;
        fade: (Component: React.ReactNode) => void;
        pushLeft: (Component: React.ReactNode) => void;
        ...
        pushDown: (Component: React.ReactNode) => void;
        pushUp: (Component: React.ReactNode) => void;
        modal: (Component: React.ReactNode, overrides?: NavigationTransitionOptions | undefined) => void;
        overlayTop: (Component: React.ReactNode, overrides?: NavigationTransitionOptions | undefined) => void;
        overlayBottom: (Component: React.ReactNode, overrides?: NavigationTransitionOptions | undefined) => void;
        overlayLeft: (Component: React.ReactNode, overrides?: NavigationTransitionOptions | undefined) => void;
        overlayRight: (Component: React.ReactNode, overrides?: NavigationTransitionOptions | undefined) => void;
        flipUp: (Component: React.ReactNode) => void;
        flipDown: (Component: React.ReactNode) => void;
        flipLeft: (Component: React.ReactNode) => void;
        flipRight: (Component: React.ReactNode) => void;
...
declare module 'framer/types/src/components/Page' {
    import * as React from "react";
    import { ScrollEvents } from "framer/types/src/components/Scroll";
    ...
    import { Rect, LayerProps, PropertyControls, Size } from "framer/types/src/render";
    import { FramerAnimation } from "framer/types/src/animation/FramerAnimation";
    import { FrameSpecificProps, FrameProperties } from "framer/types/src/render/presentation/Frame";
    import { Animatable, Change } from "framer/types/src/animation/Animatable";
    import { FramerEvent } from "framer/types/src/events";
    import { DragEvents } from "framer/types/src/components/hoc/WithDragging";
    import { Frame } from "framer/types/src/components/Frame";
    import { Cancel } from "framer/types/src/animation/Animatable/Animatable";
    ...
    export interface PageProperties extends PageSpecificProps, FrameSpecificProps, LayerProps, Partial<PageEvents>, Partial<DragEvents<typeof Frame>>, Partial<ScrollEvents> {
    }
    export class Page extends React.Component<Partial<PageProperties>, State> {
        static _stylableContainer: boolean;
        pages: {
            rect: Rect;
            effectValues: Partial<FrameProperties> | undefined;
        }[];
        ...
        cancelUpdating: Cancel | undefined;
        static pageProps: PageSpecificProps & Partial<FrameProperties>;
        ...
        readonly isHorizontalDirection: boolean;
        readonly currentContentOffset: Animatable<number>;
        boundedCurrentPage(props: PageProperties): number;
        componentWillUpdate(nextProps: PageProperties): void;
        componentDidUpdate(): void;
        nearestPageIndex: (startPosition: number, endPosition: number, isHorizontalDirection: boolean, allowSkippingPages: boolean) => number;
        ...
        contentOffsetUpdated: (change: Change<number>, transaction?: number | undefined) => void;
        render(): JSX.Element;
    }
    export {};
}
...
declare module 'framer/types/src/render/types/PropertyControls' {
    ...
    export type FlatControlDescription<P = any> = CompactControlsDescription<P> | BooleanControlDescription<P> | StringControlDescription<P> | ColorControlDescription<P> | FusedNumberControlDescription<P> | SegmentedEnumControlDescription<P> | ImageControlDescription<P> | FileControlDescription<P> | ComponentInstanceDescription<P>;
    export type ControlDescription<P = any, Q = any> = FlatControlDescription<P> | ArrayControlDescription<P, Q> | ObjectControlDescription<P, Q>;
...
declare module 'framer/types/src/render/presentation/Frame' {
    ...
    import { Size } from "framer/types/src/render/types/Size";
    import { QualityOptions } from "framer/types/src/render/utils/imageForFill";
    import { Animatable, AnimatableObject, Change, Cancel } from "framer/types/src/animation/Animatable";
    import { WithFractionOfFreeSpace } from "framer/types/src/render/traits/FreeSpace";
...
declare module 'framer/types/src/render/DesignComponentWrapper' {
    ...
    export function createDesignComponent<P>(canvas: CanvasStore, id: string, propertyControls: PropertyControls<P>, width?: ConstraintDimension, height?: ConstraintDimension): {
        new (props: P & Partial<ConstraintProperties>, context?: any): {
            ...
            _createElement(type: any, props: any, children: any[]): React.ComponentElement<any, React.Component<any, any, any>>;
            _renderData(presentation: any, componentProps: any, topLevelProps?: any): React.ComponentElement<any, React.Component<any, any, any>> | null;
            render(): React.ComponentElement<any, React.Component<any, any, any>> | React.DetailedReactHTMLElement<{
                style: React.CSSProperties;
            }, HTMLElement> | null;
            setState<K extends "data">(state: {
                ...
                data: any;
            }>, props: Readonly<P & Partial<ConstraintProperties>>) => {
                data: any;
            } | Pick<{
                data: any;
            }, K> | null) | Pick<{
